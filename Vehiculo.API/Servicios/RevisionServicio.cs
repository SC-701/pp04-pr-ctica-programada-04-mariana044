...
namespace Servicios
{
    ...
    public class RevisionServicio : IRevisionServicio
    {
        ...
        public RevisionServicio(IConfiguracion configuracion, IHttpClientFactory
            httpClient)
        {
        ...
        public async Task<Revision> Obtener(string placa)
        {
            ...
            var resutadoDeserializado = JsonSerializer.Deserialize<List<Revision>>(resultado, opciones);
            return resutadoDeserializado.FirstOrDefault();
